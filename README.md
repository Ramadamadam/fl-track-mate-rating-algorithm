...
"Runner", or a "Race Runner", is a combination of horse and race it runs in.

This concept is used in algorithm documents and in the code.  
...
* 3 parameters for the race, and 1 parameter for period
...
* (optional) create a [database](sql/jian-create-test-db.sql) and load all the data, if you don't have the data yet
...
Note: **Don't do the integration when testing is all done**, which may last a few days. Otherwise if you want any change in this project, it will be very difficult for Jian to do it

Steps:

* Copy all code under php/Tracemate/RufRatingRewrite to your system, with directory structure and namespace unchanged
...
* Call function get_ruf_ratings_for_race_next_day() inside ruf_rating.php    